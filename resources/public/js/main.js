...
textadventureeditor.client.main.exit_props_field.prototype._crateGroup = group__2982__auto___3792;
...
textadventureeditor.client.main.delete_exit_props_button.prototype._crateGroup = group__2982__auto___3796;
...
textadventureeditor.client.main.exit_div.prototype._crateGroup = group__2982__auto___3800;
textadventureeditor.client.main.$exit_div = function(a) {
...
textadventureeditor.client.main.add_fields_for_exit = function(a) {
  ...
  cljs.core.swap_BANG_.call(null, textadventureeditor.client.main.next_available_exit_index, cljs.core.inc);
  ...
  jayq.core.append.call(null, textadventureeditor.client.main.$exit_properties, textadventureeditor.client.main.exit_div.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id"], {"\ufdd0'id":[cljs.core.str(textadventureeditor.client.main.exit_div_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_exit_index))].join("")})));
  jayq.core.append.call(null, textadventureeditor.client.main.$exit_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_exit_index)), textadventureeditor.client.main.exit_props_field.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":[cljs.core.str(textadventureeditor.client.main.exit_id_field_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_exit_index))].join(""), "\ufdd0'value":b})));
  jayq.core.append.call(null, textadventureeditor.client.main.$exit_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_exit_index)), textadventureeditor.client.main.exit_props_field.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":[cljs.core.str(textadventureeditor.client.main.exit_label_field_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_exit_index))].join(""), "\ufdd0'value":d})));
...
textadventureeditor.client.main.remove_fields_for_exit = function(a) {
...
textadventureeditor.client.main.make_exit_from_fields = function(a) {
  return cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'label", "\ufdd0'destination", "\ufdd0'direction-hint"], {"\ufdd0'id":textadventureeditor.client.main.get_value.call(null, [cljs.core.str(textadventureeditor.client.main.exit_id_field_id), cljs.core.str(a)].join("")), "\ufdd0'label":textadventureeditor.client.main.get_value.call(null, [cljs.core.str(textadventureeditor.client.main.exit_label_field_id), cljs.core.str(a)].join("")), "\ufdd0'destination":textadventureeditor.client.main.get_value.call(null, 
  [cljs.core.str(textadventureeditor.client.main.exit_destination_field_id), cljs.core.str(a)].join("")), "\ufdd0'direction-hint":textadventureeditor.client.main.get_value.call(null, [cljs.core.str(textadventureeditor.client.main.exit_direction_hint_field_id), cljs.core.str(a)].join(""))})
};
textadventureeditor.client.main.gather_exits_values = function() {
  return cljs.core.doall.call(null, cljs.core.map.call(null, textadventureeditor.client.main.make_exit_from_fields, cljs.core.deref.call(null, textadventureeditor.client.main.exit_indices_for_current_location)))
};
textadventureeditor.client.main.$item_properties = jayq.core.$.call(null, "\ufdd0'#item-properties");
textadventureeditor.client.main.item_id_field_id = "item-id";
textadventureeditor.client.main.item_name_field_id = "item-name";
textadventureeditor.client.main.item_description_field_id = "item-description";
textadventureeditor.client.main.item_countable_noun_prefix_field_id = "item-countable-noun-prefix";
textadventureeditor.client.main.item_mid_sentence_cased_name_field_id = "item-mid-sentence-cased-name";
textadventureeditor.client.main.item_is_untakeable_field_id = "item-is-untakeable";
textadventureeditor.client.main.item_can_be_used_with_field_id = "item-can-be-used-with";
textadventureeditor.client.main.item_successful_use_message_field_id = "item-successful-use-message";
textadventureeditor.client.main.item_use_is_not_repeatable_field_id = "item-use-is-not-repeatable";
textadventureeditor.client.main.item_use_actions_field_id = "item-use-actions";
...
textadventureeditor.client.main.item_props_field = function(a) {
  var b = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, a = cljs.core._lookup.call(null, b, "\ufdd0'value", null), b = cljs.core._lookup.call(null, b, "\ufdd0'name", null), a = crate.core.html.call(null, crate.form.text_field.call(null, b, a));
  a.setAttribute("crateGroup", group__2982__auto___3809);
  return a
};
textadventureeditor.client.main.item_props_field.prototype._crateGroup = group__2982__auto___3809;
var group__2982__auto___3813 = cljs.core.swap_BANG_.call(null, crate.core.group_id, cljs.core.inc);
textadventureeditor.client.main.delete_item_props_button = function(a) {
  ...
  "\ufdd0'data-param", "\ufdd0'id"], {"\ufdd0'href":"#", "\ufdd0'data-action":d, "\ufdd0'data-param":c, "\ufdd0'id":a}), b], !0));
  a.setAttribute("crateGroup", group__2982__auto___3813);
  return a
};
textadventureeditor.client.main.delete_item_props_button.prototype._crateGroup = group__2982__auto___3813;
...
textadventureeditor.client.main.item_div.prototype._crateGroup = group__2982__auto___3817;
textadventureeditor.client.main.$item_div = function(a) {
  return jayq.core.$.call(null, [cljs.core.str("#"), cljs.core.str(textadventureeditor.client.main.item_div_id), cljs.core.str(a)].join(""))
};
textadventureeditor.client.main.add_fields_for_item = function(a) {
  var b = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, a = cljs.core._lookup.call(null, b, "\ufdd0'description", null), c = cljs.core._lookup.call(null, b, "\ufdd0'id", null), d = cljs.core._lookup.call(null, b, "\ufdd0'is-untakeable", null), e = cljs.core._lookup.call(null, b, "\ufdd0'countable-noun-prefix", null), f = cljs.core._lookup.call(null, b, "\ufdd0'can-be-used-with", null), g = cljs.core._lookup.call(null, b, "\ufdd0'mid-sentence-cased-name", 
  null), h = cljs.core._lookup.call(null, b, "\ufdd0'name", null), i = cljs.core._lookup.call(null, b, "\ufdd0'use-actions", null), j = cljs.core._lookup.call(null, b, "\ufdd0'successful-use-message", null), b = cljs.core._lookup.call(null, b, "\ufdd0'use-is-not-repeatable", null);
  cljs.core.swap_BANG_.call(null, textadventureeditor.client.main.next_available_item_index, cljs.core.inc);
  ...
  jayq.core.append.call(null, textadventureeditor.client.main.$item_properties, textadventureeditor.client.main.item_div.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id"], {"\ufdd0'id":[cljs.core.str(textadventureeditor.client.main.item_div_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join("")})));
  jayq.core.append.call(null, textadventureeditor.client.main.$item_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index)), textadventureeditor.client.main.item_props_field.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":[cljs.core.str(textadventureeditor.client.main.item_id_field_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join(""), "\ufdd0'value":c})));
  jayq.core.append.call(null, textadventureeditor.client.main.$item_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index)), textadventureeditor.client.main.item_props_field.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":[cljs.core.str(textadventureeditor.client.main.item_name_field_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join(""), "\ufdd0'value":h})));
  jayq.core.append.call(null, textadventureeditor.client.main.$item_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index)), textadventureeditor.client.main.item_props_field.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":[cljs.core.str(textadventureeditor.client.main.item_description_field_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join(""), "\ufdd0'value":a})));
  jayq.core.append.call(null, textadventureeditor.client.main.$item_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index)), textadventureeditor.client.main.item_props_field.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":[cljs.core.str(textadventureeditor.client.main.item_countable_noun_prefix_field_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join(""), 
  "\ufdd0'value":e})));
  jayq.core.append.call(null, textadventureeditor.client.main.$item_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index)), textadventureeditor.client.main.item_props_field.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":[cljs.core.str(textadventureeditor.client.main.item_mid_sentence_cased_name_field_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join(""), 
  "\ufdd0'value":g})));
  jayq.core.append.call(null, textadventureeditor.client.main.$item_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index)), textadventureeditor.client.main.item_props_field.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":[cljs.core.str(textadventureeditor.client.main.item_is_untakeable_field_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join(""), "\ufdd0'value":d})));
  jayq.core.append.call(null, textadventureeditor.client.main.$item_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index)), textadventureeditor.client.main.item_props_field.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":[cljs.core.str(textadventureeditor.client.main.item_can_be_used_with_field_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join(""), "\ufdd0'value":f})));
  jayq.core.append.call(null, textadventureeditor.client.main.$item_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index)), textadventureeditor.client.main.item_props_field.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":[cljs.core.str(textadventureeditor.client.main.item_successful_use_message_field_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join(""), 
  "\ufdd0'value":j})));
  jayq.core.append.call(null, textadventureeditor.client.main.$item_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index)), textadventureeditor.client.main.item_props_field.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":[cljs.core.str(textadventureeditor.client.main.item_use_is_not_repeatable_field_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join(""), 
  "\ufdd0'value":b})));
  jayq.core.append.call(null, textadventureeditor.client.main.$item_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index)), textadventureeditor.client.main.item_props_field.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":[cljs.core.str(textadventureeditor.client.main.item_use_actions_field_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join(""), "\ufdd0'value":i})));
...
textadventureeditor.client.main.remove_fields_for_item = function(a) {
...
textadventureeditor.client.main.show_location_items = function(a) {
  cljs.core.doall.call(null, cljs.core.map.call(null, textadventureeditor.client.main.remove_fields_for_item, cljs.core.deref.call(null, textadventureeditor.client.main.item_indices_for_current_location)));
  cljs.core.swap_BANG_.call(null, textadventureeditor.client.main.item_indices_for_current_location, function() {
    return cljs.core.PersistentVector.EMPTY
  });
  cljs.core.swap_BANG_.call(null, textadventureeditor.client.main.next_available_item_index, function() {
    return 0
  });
  return cljs.core.doall.call(null, cljs.core.map.call(null, function(a) {
    return textadventureeditor.client.main.add_fields_for_item.call(null, a)
  }, (new cljs.core.Keyword("\ufdd0'items")).call(null, a)))
};
...
textadventureeditor.client.main.make_location_current = function(a) {
  ...
  textadventureeditor.client.main.show_location_exits.call(null, a);
  return textadventureeditor.client.main.show_location_items.call(null, a)
};
...
cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'label", "\ufdd0'destination", "\ufdd0'direction-hint"], {"\ufdd0'id":"exit2", "\ufdd0'label":"east", "\ufdd0'destination":"loc2", "\ufdd0'direction-hint":"EAST"})], !0), "\ufdd0'items":cljs.core.PersistentVector.fromArray([cljs.core.ObjMap.fromObject("\ufdd0'countable-noun-prefix \ufdd0'mid-sentence-cased-name \ufdd0'can-be-used-with \ufdd0'name \ufdd0'use-actions \ufdd0'successful-use-message \ufdd0'use-is-not-repeatable \ufdd0'id \ufdd0'description \ufdd0'is-untakeable".split(" "), 
{"\ufdd0'countable-noun-prefix":"a", "\ufdd0'mid-sentence-cased-name":"item name cased name", "\ufdd0'can-be-used-with":"nothing", "\ufdd0'name":"item name", "\ufdd0'use-actions":cljs.core.PersistentVector.EMPTY, "\ufdd0'successful-use-message":"success!", "\ufdd0'use-is-not-repeatable":!1, "\ufdd0'id":"item id", "\ufdd0'description":"item description", "\ufdd0'is-untakeable":!1})], !0)}));
...
textadventureeditor.client.main.locprops_add_exit_button.prototype._crateGroup = group__2982__auto___3828;
