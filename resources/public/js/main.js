...
textadventureeditor.client.serialiser.serialise_location = function(a) {
  return[cljs.core.str("LOCATION\n"), cljs.core.str("x:"), cljs.core.str((new cljs.core.Keyword("\ufdd0'x")).call(null, a)), cljs.core.str("\n"), cljs.core.str("y:"), cljs.core.str((new cljs.core.Keyword("\ufdd0'y")).call(null, a)), cljs.core.str("\n"), cljs.core.str("location id:"), cljs.core.str((new cljs.core.Keyword("\ufdd0'id")).call(null, a)), cljs.core.str("\n"), cljs.core.str("location description:"), cljs.core.str(clojure.string.trim_newline.call(null, (new cljs.core.Keyword("\ufdd0'description")).call(null, 
...
textadventureeditor.client.main.draw_editor = function(a, b) {
...
textadventureeditor.client.main.white = "#FFFFFF";
textadventureeditor.client.main.black = "#000000";
...
textadventureeditor.client.main.loc_stroke_style = function(a) {
  return cljs.core.truth_((new cljs.core.Keyword("\ufdd0'current")).call(null, a)) ? textadventureeditor.client.main.asparagus : textadventureeditor.client.main.dark_spring_green
};
textadventureeditor.client.main.loc_stroke_width = function(a) {
  return cljs.core.truth_((new cljs.core.Keyword("\ufdd0'current")).call(null, a)) ? 2 : 1
};
...
textadventureeditor.client.main.find_loc_by_id = function(a) {
...
textadventureeditor.client.main.draw_line = function(a, b, c) {
  return monet.canvas.stroke.call(null, monet.canvas.close_path.call(null, monet.canvas.line_to.call(null, monet.canvas.move_to.call(null, monet.canvas.begin_path.call(null, textadventureeditor.client.monetfixes.stroke_width_that_works.call(null, textadventureeditor.client.monetfixes.stroke_style_that_works.call(null, a, textadventureeditor.client.main.white), 2)), (new cljs.core.Keyword("\ufdd0'x")).call(null, b), (new cljs.core.Keyword("\ufdd0'y")).call(null, b)), (new cljs.core.Keyword("\ufdd0'x")).call(null, 
...
textadventureeditor.client.main.to_the_right_of_QMARK_ = function(a, b) {
  return(new cljs.core.Keyword("\ufdd0'x")).call(null, a) > (new cljs.core.Keyword("\ufdd0'x")).call(null, b) + (new cljs.core.Keyword("\ufdd0'w")).call(null, b)
};
textadventureeditor.client.main.to_the_left_of_QMARK_ = function(a, b) {
  return(new cljs.core.Keyword("\ufdd0'x")).call(null, a) < (new cljs.core.Keyword("\ufdd0'x")).call(null, b)
};
textadventureeditor.client.main.offset_up_from_center_of_location = function(a) {
  var b = textadventureeditor.client.main.center_of_location.call(null, a);
  return cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y"], {"\ufdd0'x":(new cljs.core.Keyword("\ufdd0'x")).call(null, b), "\ufdd0'y":(new cljs.core.Keyword("\ufdd0'y")).call(null, b) - (new cljs.core.Keyword("\ufdd0'h")).call(null, a) / 4})
};
textadventureeditor.client.main.offset_down_from_center_of_location = function(a) {
  var b = textadventureeditor.client.main.center_of_location.call(null, a);
  return cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y"], {"\ufdd0'x":(new cljs.core.Keyword("\ufdd0'x")).call(null, b), "\ufdd0'y":(new cljs.core.Keyword("\ufdd0'y")).call(null, b) + (new cljs.core.Keyword("\ufdd0'h")).call(null, a) / 4})
};
textadventureeditor.client.main.offset_left_from_center_of_location = function(a) {
  var b = textadventureeditor.client.main.center_of_location.call(null, a);
  return cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y"], {"\ufdd0'x":(new cljs.core.Keyword("\ufdd0'x")).call(null, b) - (new cljs.core.Keyword("\ufdd0'h")).call(null, a) / 4, "\ufdd0'y":(new cljs.core.Keyword("\ufdd0'y")).call(null, b)})
};
textadventureeditor.client.main.offset_right_from_center_of_location = function(a) {
  var b = textadventureeditor.client.main.center_of_location.call(null, a);
  return cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y"], {"\ufdd0'x":(new cljs.core.Keyword("\ufdd0'x")).call(null, b) + (new cljs.core.Keyword("\ufdd0'h")).call(null, a) / 4, "\ufdd0'y":(new cljs.core.Keyword("\ufdd0'y")).call(null, b)})
};
textadventureeditor.client.main.find_arrow_base_first_point = function(a, b) {
  return cljs.core.truth_(textadventureeditor.client.main.to_the_right_of_QMARK_.call(null, b, a)) ? textadventureeditor.client.main.offset_up_from_center_of_location.call(null, a) : cljs.core.truth_(textadventureeditor.client.main.to_the_left_of_QMARK_.call(null, b, a)) ? textadventureeditor.client.main.offset_up_from_center_of_location.call(null, a) : textadventureeditor.client.main.offset_left_from_center_of_location.call(null, a)
};
textadventureeditor.client.main.find_arrow_base_second_point = function(a, b) {
  return cljs.core.truth_(textadventureeditor.client.main.to_the_right_of_QMARK_.call(null, b, a)) ? textadventureeditor.client.main.offset_down_from_center_of_location.call(null, a) : cljs.core.truth_(textadventureeditor.client.main.to_the_left_of_QMARK_.call(null, b, a)) ? textadventureeditor.client.main.offset_down_from_center_of_location.call(null, a) : textadventureeditor.client.main.offset_right_from_center_of_location.call(null, a)
};
textadventureeditor.client.main.draw_arrow = function(a, b, c) {
  var d = textadventureeditor.client.main.find_arrow_base_first_point.call(null, c, b), c = textadventureeditor.client.main.find_arrow_base_second_point.call(null, c, b);
  return textadventureeditor.client.main.draw_triangle.call(null, a, d, c, b)
};
textadventureeditor.client.main.draw_exit_arrow = function(a, b, c) {
  var b = textadventureeditor.client.main.find_loc_by_id.call(null, (new cljs.core.Keyword("\ufdd0'destination")).call(null, b)), d = !cljs.core._EQ_.call(null, b, null) ? textadventureeditor.client.main.center_of_location.call(null, b) : null;
  return cljs.core._EQ_.call(null, b, null) ? null : textadventureeditor.client.main.draw_arrow.call(null, a, d, c)
};
textadventureeditor.client.main.draw_exit_arrows = function(a, b) {
  return cljs.core.doall.call(null, cljs.core.map.call(null, function(c) {
    return textadventureeditor.client.main.draw_exit_arrow.call(null, a, c, b)
  }, (new cljs.core.Keyword("\ufdd0'exits")).call(null, b)))
};
textadventureeditor.client.main.draw_location_box = function(a, b) {
...
textadventureeditor.client.main.draw_location_text = function(a, b) {
  return monet.canvas.text.call(null, textadventureeditor.client.monetfixes.font_style_that_works.call(null, textadventureeditor.client.monetfixes.fill_style_that_works.call(null, a, textadventureeditor.client.main.white), "14px sans-serif"), cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y", "\ufdd0'text"], {"\ufdd0'x":(new cljs.core.Keyword("\ufdd0'x")).call(null, b), "\ufdd0'y":(new cljs.core.Keyword("\ufdd0'y")).call(null, textadventureeditor.client.main.center_of_location.call(null, b)), "\ufdd0'text":(new cljs.core.Keyword("\ufdd0'id")).call(null, 
  b)}))
};
textadventureeditor.client.main.draw_location = function(a, b) {
  textadventureeditor.client.main.draw_location_box.call(null, a, b);
  return textadventureeditor.client.main.draw_location_text.call(null, a, b)
};
textadventureeditor.client.main.draw_locations = function(a) {
  for(var b = cljs.core.seq.call(null, cljs.core.vals.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.locations)));;) {
    if(b) {
      var c = cljs.core.first.call(null, b);
      textadventureeditor.client.main.draw_exit_arrows.call(null, a, c);
      b = cljs.core.next.call(null, b)
    }else {
      break
    }
  }
  for(b = cljs.core.seq.call(null, cljs.core.vals.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.locations)));;) {
    if(b) {
      c = cljs.core.first.call(null, b), textadventureeditor.client.main.draw_location.call(null, a, c), b = cljs.core.next.call(null, b)
    }else {
      return null
    }
  }
...
textadventureeditor.client.main.get_id = function(a) {
  return goog.dom.getElement(a).id
};
...
var group__2983__auto___3835 = cljs.core.swap_BANG_.call(null, crate.core.group_id, cljs.core.inc);
textadventureeditor.client.main.make_text_field = function(a) {
  ...
  a.setAttribute("crateGroup", group__2983__auto___3835);
  return a
};
textadventureeditor.client.main.make_text_field.prototype._crateGroup = group__2983__auto___3835;
var group__2983__auto___3839 = cljs.core.swap_BANG_.call(null, crate.core.group_id, cljs.core.inc);
textadventureeditor.client.main.make_check_box_field = function(a) {
  ...
  a.setAttribute("crateGroup", group__2983__auto___3839);
  return a
};
textadventureeditor.client.main.make_check_box_field.prototype._crateGroup = group__2983__auto___3839;
var group__2983__auto___3843 = cljs.core.swap_BANG_.call(null, crate.core.group_id, cljs.core.inc);
textadventureeditor.client.main.make_div = function(a) {
  ...
  a.setAttribute("crateGroup", group__2983__auto___3843);
  return a
};
textadventureeditor.client.main.make_div.prototype._crateGroup = group__2983__auto___3843;
var group__2983__auto___3847 = cljs.core.swap_BANG_.call(null, crate.core.group_id, cljs.core.inc);
textadventureeditor.client.main.make_label = function(a) {
  ...
  a.setAttribute("crateGroup", group__2983__auto___3847);
  return a
};
textadventureeditor.client.main.make_label.prototype._crateGroup = group__2983__auto___3847;
...
textadventureeditor.client.main.add_property_fields = function(a, b) {
  ...
  var f = (new cljs.core.Keyword("\ufdd0'fields-info")).call(null, a), g = (new cljs.core.Keyword("\ufdd0'parent-div")).call(null, a), h = (new cljs.core.Keyword("\ufdd0'div-base-id")).call(null, a);
  cljs.core.swap_BANG_.call(null, e, cljs.core.inc);
  cljs.core.swap_BANG_.call(null, d, cljs.core.conj, cljs.core.deref.call(null, e));
  jayq.core.append.call(null, g, textadventureeditor.client.main.make_div.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id"], {"\ufdd0'id":[cljs.core.str(h), cljs.core.str(cljs.core.deref.call(null, e))].join("")})));
  var i = c.call(null, cljs.core.deref.call(null, e)), c = cljs.core.select_keys.call(null, b, cljs.core.keys.call(null, f));
  return cljs.core.doall.call(null, cljs.core.map.call(null, function(a) {
    return textadventureeditor.client.main.extract_field_and_label.call(null, a.call(null, f), a.call(null, b), i, cljs.core.deref.call(null, e))
  }, cljs.core.keys.call(null, c)))
};
textadventureeditor.client.main.add_all_property_fields = function(a, b) {
  textadventureeditor.client.main.add_property_fields.call(null, a, b);
  return(new cljs.core.Keyword("\ufdd0'extra-field-adding-func")).call(null, a).call(null, b)
};
textadventureeditor.client.main.reset_property = function(a) {
  var b = (new cljs.core.Keyword("\ufdd0'div-func")).call(null, a), c = (new cljs.core.Keyword("\ufdd0'indices-atom")).call(null, a), d = (new cljs.core.Keyword("\ufdd0'next-index-atom")).call(null, a);
  cljs.core.doall.call(null, cljs.core.map.call(null, function(a) {
    return jayq.core.remove.call(null, b.call(null, a))
  }, cljs.core.deref.call(null, c)));
  cljs.core.swap_BANG_.call(null, c, function() {
    return cljs.core.PersistentVector.EMPTY
  });
  cljs.core.swap_BANG_.call(null, d, function() {
    return 0
  });
  c = (new cljs.core.Keyword("\ufdd0'reset-nested-properties")).call(null, a);
  return cljs.core._EQ_.call(null, null, c) ? null : c.call(null, a)
};
textadventureeditor.client.main.show_location_sub_properties = function(a, b) {
  textadventureeditor.client.main.reset_property.call(null, b);
  return cljs.core.doall.call(null, cljs.core.map.call(null, function(a) {
    return textadventureeditor.client.main.add_all_property_fields.call(null, b, a)
  }, (new cljs.core.Keyword("\ufdd0'location-property")).call(null, b).call(null, a)))
};
...
textadventureeditor.client.main.add_nested_values_to_property_values = function(a, b, c) {
  ...
  b = (new cljs.core.Keyword("\ufdd0'gather-nested-values")).call(null, a).call(null, a, (new cljs.core.Keyword("\ufdd0'div-func")).call(null, a).call(null, b));
...
textadventureeditor.client.main.exit_fields_info = cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'label", "\ufdd0'destination", "\ufdd0'direction-hint", "\ufdd0'is-not-visible"], {"\ufdd0'id":cljs.core.ObjMap.fromObject(["\ufdd0'field-id", "\ufdd0'label", "\ufdd0'type"], {"\ufdd0'field-id":"exit-id", "\ufdd0'label":"exit id", "\ufdd0'type":"\ufdd0'textfield"}), "\ufdd0'label":cljs.core.ObjMap.fromObject(["\ufdd0'field-id", "\ufdd0'label", "\ufdd0'type"], {"\ufdd0'field-id":"exit-label", "\ufdd0'label":"exit label", 
"\ufdd0'type":"\ufdd0'textfield"}), "\ufdd0'destination":cljs.core.ObjMap.fromObject(["\ufdd0'field-id", "\ufdd0'label", "\ufdd0'type"], {"\ufdd0'field-id":"exit-destination", "\ufdd0'label":"exit destination", "\ufdd0'type":"\ufdd0'textfield"}), "\ufdd0'direction-hint":cljs.core.ObjMap.fromObject(["\ufdd0'field-id", "\ufdd0'label", "\ufdd0'type"], {"\ufdd0'field-id":"exit-direction-hint", "\ufdd0'label":"exit direction hint", "\ufdd0'type":"\ufdd0'textfield"}), "\ufdd0'is-not-visible":cljs.core.ObjMap.fromObject(["\ufdd0'field-id", 
"\ufdd0'label", "\ufdd0'type"], {"\ufdd0'field-id":"exit-is-not-visible", "\ufdd0'label":"exit is not visible", "\ufdd0'type":"\ufdd0'checkbox"})});
...
var group__2983__auto___3864 = cljs.core.swap_BANG_.call(null, crate.core.group_id, cljs.core.inc);
textadventureeditor.client.main.delete_exit_props_button = function(a) {
  ...
  a.setAttribute("crateGroup", group__2983__auto___3864);
  return a
};
textadventureeditor.client.main.delete_exit_props_button.prototype._crateGroup = group__2983__auto___3864;
...
textadventureeditor.client.main.add_extra_fields_for_exit = function() {
  var a = textadventureeditor.client.main.$exit_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_exit_index));
  return jayq.core.append.call(null, a, textadventureeditor.client.main.delete_exit_props_button.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'label", "\ufdd0'action", "\ufdd0'param", "\ufdd0'id"], {"\ufdd0'label":"delete", "\ufdd0'action":[cljs.core.str(textadventureeditor.client.main.exit_delete_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_exit_index))].join(""), "\ufdd0'param":cljs.core.deref.call(null, textadventureeditor.client.main.next_available_exit_index), 
  "\ufdd0'id":[cljs.core.str(textadventureeditor.client.main.exit_delete_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_exit_index))].join("")})))
};
...
textadventureeditor.client.main.exits_sub_property = cljs.core.ObjMap.fromObject("\ufdd0'value-gatherer-func \ufdd0'delete-button-partial-func \ufdd0'fields-info \ufdd0'indices-atom \ufdd0'div-base-id \ufdd0'gather-nested-values \ufdd0'div-func \ufdd0'location-property \ufdd0'parent-div \ufdd0'next-index-atom \ufdd0'reset-nested-properties \ufdd0'nested-values-key \ufdd0'extra-field-adding-func".split(" "), {"\ufdd0'value-gatherer-func":textadventureeditor.client.main.gather_exit_values, "\ufdd0'delete-button-partial-func":textadventureeditor.client.main.delete_exit_props_button, 
...
"\ufdd0'reset-nested-properties":null, "\ufdd0'nested-values-key":null, "\ufdd0'extra-field-adding-func":textadventureeditor.client.main.add_extra_fields_for_exit});
...
"\ufdd0'type":"\ufdd0'textfield"})});
textadventureeditor.client.main.item_action_div_id = "single-item-action";
textadventureeditor.client.main.next_available_item_action_index = cljs.core.atom.call(null, 0);
textadventureeditor.client.main.item_action_indices_for_current_location = cljs.core.atom.call(null, cljs.core.PersistentVector.EMPTY);
textadventureeditor.client.main.$item_action_div = function(a) {
  return jayq.core.$.call(null, [cljs.core.str("#"), cljs.core.str(textadventureeditor.client.main.item_action_div_id), cljs.core.str(a)].join(""))
};
textadventureeditor.client.main.add_extra_fields_for_item_action = function(a, b) {
  return textadventureeditor.client.main.add_property_fields.call(null, a, b)
};
textadventureeditor.client.main.add_item_actions = function(a, b) {
  return cljs.core.doall.call(null, cljs.core.map.call(null, function(b) {
    return(new cljs.core.Keyword("\ufdd0'extra-field-adding-func")).call(null, a).call(null, a, b)
  }, b))
};
textadventureeditor.client.main.gather_item_action_values = function(a) {
  return textadventureeditor.client.main.gather_values_for_sub_property.call(null, a)
};
textadventureeditor.client.main.item_actions_sub_property = cljs.core.ObjMap.fromObject("\ufdd0'value-gatherer-func \ufdd0'fields-info \ufdd0'indices-atom \ufdd0'div-base-id \ufdd0'gather-nested-values \ufdd0'div-func \ufdd0'next-index-atom \ufdd0'reset-nested-properties \ufdd0'nested-values-key \ufdd0'extra-field-adding-func".split(" "), {"\ufdd0'value-gatherer-func":textadventureeditor.client.main.gather_item_action_values, "\ufdd0'fields-info":textadventureeditor.client.main.item_action_fields_info, 
"\ufdd0'indices-atom":textadventureeditor.client.main.item_action_indices_for_current_location, "\ufdd0'div-base-id":textadventureeditor.client.main.item_action_div_id, "\ufdd0'gather-nested-values":null, "\ufdd0'div-func":textadventureeditor.client.main.$item_action_div, "\ufdd0'next-index-atom":textadventureeditor.client.main.next_available_item_action_index, "\ufdd0'reset-nested-properties":null, "\ufdd0'nested-values-key":null, "\ufdd0'extra-field-adding-func":textadventureeditor.client.main.add_extra_fields_for_item_action});
...
"\ufdd0'name":cljs.core.ObjMap.fromObject(["\ufdd0'field-id", "\ufdd0'label", "\ufdd0'type"], {"\ufdd0'field-id":"item-name", "\ufdd0'label":"item name", "\ufdd0'type":"\ufdd0'textfield"}), "\ufdd0'successful-use-message":cljs.core.ObjMap.fromObject(["\ufdd0'field-id", "\ufdd0'label", "\ufdd0'type"], {"\ufdd0'field-id":"item-successful-use-message", "\ufdd0'label":"item successful use message", "\ufdd0'type":"\ufdd0'textfield"}), "\ufdd0'use-is-not-repeatable":cljs.core.ObjMap.fromObject(["\ufdd0'field-id", 
"\ufdd0'label", "\ufdd0'type"], {"\ufdd0'field-id":"item-use-is-not-repeatable", "\ufdd0'label":"item use is not repeatable", "\ufdd0'type":"\ufdd0'checkbox"}), "\ufdd0'id":cljs.core.ObjMap.fromObject(["\ufdd0'field-id", "\ufdd0'label", "\ufdd0'type"], {"\ufdd0'field-id":"item-id", "\ufdd0'label":"item id", "\ufdd0'type":"\ufdd0'textfield"}), "\ufdd0'description":cljs.core.ObjMap.fromObject(["\ufdd0'field-id", "\ufdd0'label", "\ufdd0'type"], {"\ufdd0'field-id":"item-description", "\ufdd0'label":"item description", 
"\ufdd0'type":"\ufdd0'textfield"}), "\ufdd0'is-untakeable":cljs.core.ObjMap.fromObject(["\ufdd0'field-id", "\ufdd0'label", "\ufdd0'type"], {"\ufdd0'field-id":"item-is-untakeable", "\ufdd0'label":"item is untakeable", "\ufdd0'type":"\ufdd0'checkbox"})});
...
var group__2983__auto___3869 = cljs.core.swap_BANG_.call(null, crate.core.group_id, cljs.core.inc);
textadventureeditor.client.main.delete_item_props_button = function(a) {
  ...
  "\ufdd0'data-param", "\ufdd0'id"], {"\ufdd0'href":"#", "\ufdd0'data-action":d, "\ufdd0'data-param":c, "\ufdd0'id":a}), b], !0));
  a.setAttribute("crateGroup", group__2983__auto___3869);
  return a
};
textadventureeditor.client.main.delete_item_props_button.prototype._crateGroup = group__2983__auto___3869;
...
textadventureeditor.client.main.add_extra_fields_for_item = function(a) {
  var b = textadventureeditor.client.main.$item_div.call(null, cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index));
  jayq.core.append.call(null, b, textadventureeditor.client.main.delete_item_props_button.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'label", "\ufdd0'action", "\ufdd0'param", "\ufdd0'id"], {"\ufdd0'label":"delete", "\ufdd0'action":[cljs.core.str(textadventureeditor.client.main.item_delete_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join(""), "\ufdd0'param":cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index), 
  "\ufdd0'id":[cljs.core.str(textadventureeditor.client.main.item_delete_id), cljs.core.str(cljs.core.deref.call(null, textadventureeditor.client.main.next_available_item_index))].join("")})));
  return textadventureeditor.client.main.add_item_actions.call(null, cljs.core.assoc.call(null, textadventureeditor.client.main.item_actions_sub_property, "\ufdd0'parent-div", b), (new cljs.core.Keyword("\ufdd0'use-actions")).call(null, a))
};
textadventureeditor.client.main.gather_item_values = function(a) {
  return textadventureeditor.client.main.gather_values_for_sub_property.call(null, a)
};
textadventureeditor.client.main.child_ids_for_div = function(a, b) {
  var c = jayq.core.children.call(null, a), c = cljs.core.doall.call(null, cljs.core.map.call(null, function(a) {
    return textadventureeditor.client.main.get_id.call(null, a)
  }, c)), d = (new cljs.core.Keyword("\ufdd0'div-base-id")).call(null, b), e = cljs.core.deref.call(null, (new cljs.core.Keyword("\ufdd0'indices-atom")).call(null, b)), f = cljs.core.doall.call(null, cljs.core.map.call(null, function(a) {
    return[cljs.core.str(d), cljs.core.str(a)].join("")
  }, e)), g = cljs.core.reduce.call(null, cljs.core.into, cljs.core.doall.call(null, cljs.core.map.call(null, function(a) {
    return cljs.core.PersistentArrayMap.fromArrays([cljs.core.keyword.call(null, [cljs.core.str(d), cljs.core.str(a)].join(""))], [a])
  }, e))), c = clojure.set.intersection.call(null, cljs.core.set.call(null, c), cljs.core.set.call(null, f));
  return cljs.core.doall.call(null, cljs.core.map.call(null, function(a) {
    return cljs.core.keyword.call(null, a).call(null, g)
  }, c))
};
textadventureeditor.client.main.gather_item_action_values = function(a, b) {
  return textadventureeditor.client.main.gather_values_for_sub_property.call(null, textadventureeditor.client.main.item_actions_sub_property, textadventureeditor.client.main.child_ids_for_div.call(null, b, textadventureeditor.client.main.item_actions_sub_property))
};
textadventureeditor.client.main.reset_item_action_property = function() {
  return textadventureeditor.client.main.reset_property.call(null, textadventureeditor.client.main.item_actions_sub_property)
};
...
"\ufdd0'reset-nested-properties":textadventureeditor.client.main.reset_item_action_property, "\ufdd0'nested-values-key":"\ufdd0'use-actions", "\ufdd0'extra-field-adding-func":textadventureeditor.client.main.add_extra_fields_for_item});
...
textadventureeditor.client.main.loc_x_field_id = "location x";
textadventureeditor.client.main.loc_y_field_id = "location y";
...
textadventureeditor.client.main.change_location_x = function(a, b) {
  cljs.core.swap_BANG_.call(null, textadventureeditor.client.main.locations, cljs.core.dissoc, cljs.core.PersistentVector.fromArray([(new cljs.core.Keyword("\ufdd0'x")).call(null, a), (new cljs.core.Keyword("\ufdd0'y")).call(null, a)], !0));
  return cljs.core.swap_BANG_.call(null, textadventureeditor.client.main.locations, cljs.core.assoc, cljs.core.PersistentVector.fromArray([b, (new cljs.core.Keyword("\ufdd0'y")).call(null, a)], !0), cljs.core.assoc.call(null, a, "\ufdd0'x", b))
};
textadventureeditor.client.main.change_location_y = function(a, b) {
  cljs.core.swap_BANG_.call(null, textadventureeditor.client.main.locations, cljs.core.dissoc, cljs.core.PersistentVector.fromArray([(new cljs.core.Keyword("\ufdd0'x")).call(null, a), (new cljs.core.Keyword("\ufdd0'y")).call(null, a)], !0));
  return cljs.core.swap_BANG_.call(null, textadventureeditor.client.main.locations, cljs.core.assoc, cljs.core.PersistentVector.fromArray([(new cljs.core.Keyword("\ufdd0'x")).call(null, a), b], !0), cljs.core.assoc.call(null, a, "\ufdd0'y", b))
};
textadventureeditor.client.main.change_location_property = function(a, b, c) {
  var d = cljs.core._EQ_;
  return d.call(null, "\ufdd0'x", b) ? textadventureeditor.client.main.change_location_x.call(null, a, c) : d.call(null, "\ufdd0'y", b) ? textadventureeditor.client.main.change_location_y.call(null, a, c) : cljs.core.swap_BANG_.call(null, textadventureeditor.client.main.locations, cljs.core.assoc, cljs.core.PersistentVector.fromArray([(new cljs.core.Keyword("\ufdd0'x")).call(null, a), (new cljs.core.Keyword("\ufdd0'y")).call(null, a)], !0), cljs.core.assoc.call(null, a, b, c))
};
textadventureeditor.client.main.show_location_information = function(a) {
  textadventureeditor.client.main.set_value.call(null, textadventureeditor.client.main.loc_x_field_id, (new cljs.core.Keyword("\ufdd0'x")).call(null, a));
  textadventureeditor.client.main.set_value.call(null, textadventureeditor.client.main.loc_y_field_id, (new cljs.core.Keyword("\ufdd0'y")).call(null, a));
...
textadventureeditor.client.main.snap_x_to_grid = function(a) {
  return a - cljs.core.rem.call(null, a, textadventureeditor.client.main.grid_x_step.call(null))
};
textadventureeditor.client.main.snap_y_to_grid = function(a) {
  return a - cljs.core.rem.call(null, a, textadventureeditor.client.main.grid_y_step.call(null))
};
textadventureeditor.client.main.snap_to_grid = function(a, b) {
  return cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y"], {"\ufdd0'x":textadventureeditor.client.main.snap_x_to_grid.call(null, a), "\ufdd0'y":textadventureeditor.client.main.snap_y_to_grid.call(null, b)})
};
...
textadventureeditor.client.main.make_location.call(null, cljs.core.ObjMap.fromObject("\ufdd0'x \ufdd0'y \ufdd0'id \ufdd0'description \ufdd0'exits \ufdd0'items".split(" "), {"\ufdd0'x":100, "\ufdd0'y":100, "\ufdd0'id":"loc1", "\ufdd0'description":"description1", "\ufdd0'exits":cljs.core.PersistentVector.fromArray([cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'label", "\ufdd0'destination", "\ufdd0'direction-hint", "\ufdd0'is-not-visible"], {"\ufdd0'id":"exit2", "\ufdd0'label":"east", "\ufdd0'destination":"loc2", 
"\ufdd0'direction-hint":"East", "\ufdd0'is-not-visible":!1})], !0), "\ufdd0'items":cljs.core.PersistentVector.fromArray([cljs.core.ObjMap.fromObject("\ufdd0'countable-noun-prefix \ufdd0'mid-sentence-cased-name \ufdd0'can-be-used-with \ufdd0'name \ufdd0'use-actions \ufdd0'successful-use-message \ufdd0'use-is-not-repeatable \ufdd0'id \ufdd0'description \ufdd0'is-untakeable".split(" "), {"\ufdd0'countable-noun-prefix":"a", "\ufdd0'mid-sentence-cased-name":"item name cased name", "\ufdd0'can-be-used-with":"nothing", 
"\ufdd0'name":"item name", "\ufdd0'use-actions":cljs.core.PersistentVector.fromArray([cljs.core.ObjMap.fromObject(["\ufdd0'action", "\ufdd0'param"], {"\ufdd0'action":"change item description", "\ufdd0'param":"It is unlocked."}), cljs.core.ObjMap.fromObject(["\ufdd0'action", "\ufdd0'param"], {"\ufdd0'action":"change item name", "\ufdd0'param":"unlocked door"}), cljs.core.ObjMap.fromObject(["\ufdd0'action", "\ufdd0'param"], {"\ufdd0'action":"make exit visible", "\ufdd0'param":"clocktowerdoor"})], !0), 
"\ufdd0'successful-use-message":"success!", "\ufdd0'use-is-not-repeatable":!1, "\ufdd0'id":"item id", "\ufdd0'description":"item description", "\ufdd0'is-untakeable":!1})], !0)}));
textadventureeditor.client.main.make_location.call(null, cljs.core.ObjMap.fromObject("\ufdd0'x \ufdd0'y \ufdd0'id \ufdd0'description \ufdd0'exits \ufdd0'items".split(" "), {"\ufdd0'x":300, "\ufdd0'y":200, "\ufdd0'id":"loc2", "\ufdd0'description":"description2", "\ufdd0'exits":cljs.core.PersistentVector.fromArray([cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'label", "\ufdd0'destination", "\ufdd0'direction-hint", "\ufdd0'is-not-visible"], {"\ufdd0'id":"exit1", "\ufdd0'label":"south", "\ufdd0'destination":"loc1", 
"\ufdd0'direction-hint":"South", "\ufdd0'is-not-visible":!1})], !0), "\ufdd0'items":cljs.core.PersistentVector.EMPTY}));
...
var group__2983__auto___3885 = cljs.core.swap_BANG_.call(null, crate.core.group_id, cljs.core.inc);
textadventureeditor.client.main.locprops_add_exit_button = function(a) {
  ...
  "\ufdd0'data-param":a}), b], !0));
  a.setAttribute("crateGroup", group__2983__auto___3885);
  return a
};
textadventureeditor.client.main.locprops_add_exit_button.prototype._crateGroup = group__2983__auto___3885;
...
textadventureeditor.client.main.default_exit = function() {
  return cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'label", "\ufdd0'destination", "\ufdd0'direction-hint", "\ufdd0'is-not-visible"], {"\ufdd0'id":"default id", "\ufdd0'label":"default label", "\ufdd0'destination":"default destination", "\ufdd0'direction-hint":"default direction hint", "\ufdd0'is-not-visible":!1})
};
...
var group__2983__auto___3889 = cljs.core.swap_BANG_.call(null, crate.core.group_id, cljs.core.inc);
textadventureeditor.client.main.locprops_add_item_button = function(a) {
  ...
  "\ufdd0'data-param":a}), b], !0));
  a.setAttribute("crateGroup", group__2983__auto___3889);
  return a
};
textadventureeditor.client.main.locprops_add_item_button.prototype._crateGroup = group__2983__auto___3889;
...
var group__2983__auto___3893 = cljs.core.swap_BANG_.call(null, crate.core.group_id, cljs.core.inc);
textadventureeditor.client.main.locprops_save_button = function(a) {
  ...
  "\ufdd0'data-param":a}), b], !0));
  a.setAttribute("crateGroup", group__2983__auto___3893);
  return a
};
textadventureeditor.client.main.locprops_save_button.prototype._crateGroup = group__2983__auto___3893;
...
jayq.core.delegate.call(null, textadventureeditor.client.main.$body, textadventureeditor.client.main.locprops_save_button, "\ufdd0'click", function(a) {
  a.preventDefault();
  textadventureeditor.client.main.change_location_property.call(null, textadventureeditor.client.main.find_current_location.call(null), "\ufdd0'x", textadventureeditor.client.main.snap_x_to_grid.call(null, textadventureeditor.client.main.get_value.call(null, textadventureeditor.client.main.loc_x_field_id)));
  textadventureeditor.client.main.change_location_property.call(null, textadventureeditor.client.main.find_current_location.call(null), "\ufdd0'y", textadventureeditor.client.main.snap_y_to_grid.call(null, textadventureeditor.client.main.get_value.call(null, textadventureeditor.client.main.loc_y_field_id)));
  ...
  return textadventureeditor.client.main.make_location_current.call(null, textadventureeditor.client.main.find_current_location.call(null))
});
var group__2983__auto___3897 = cljs.core.swap_BANG_.call(null, crate.core.group_id, cljs.core.inc);
textadventureeditor.client.main.import_button = function(a) {
  var b = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, a = cljs.core._lookup.call(null, b, "\ufdd0'param", null), c = cljs.core._lookup.call(null, b, "\ufdd0'action", null), b = cljs.core._lookup.call(null, b, "\ufdd0'label", null), a = crate.core.html.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'a.button.import-button", cljs.core.ObjMap.fromObject(["\ufdd0'href", "\ufdd0'data-action", "\ufdd0'data-param"], {"\ufdd0'href":"#", "\ufdd0'data-action":c, 
  "\ufdd0'data-param":a}), b], !0));
  a.setAttribute("crateGroup", group__2983__auto___3897);
  return a
};
textadventureeditor.client.main.import_button.prototype._crateGroup = group__2983__auto___3897;
